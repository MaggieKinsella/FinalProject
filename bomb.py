...
# import PacMan
from bomb_GUI_PacMan import PacManApp
...
def launch_main_gui():
    ...
    def launch_pacman():
        pacman_window = tk.Toplevel(window)
        pacman_window.title("PacMan Game")
        pacman_window.attributes("--full-screen", True)
...
def main():
    pacman_root = Tj()
    app = PacManApp(pacman_root, on_game_over=launch_main_gui)
    pacman_root.mainloop()
